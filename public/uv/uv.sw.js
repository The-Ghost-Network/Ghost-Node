...
function errorTemplate(
    ...
    return (
        ...
        * { background-color: white }
        ...
        <body>
        <h1 id='errorTitle'>Error processing your request (basiccally nobodycares was being stupid when setting up uv)</h1>
        <hr />
        <p>Failed to load <b id="fetchedURL"></b> report this shit to nobodycares on our <a href="https://discord.gg/dbyDXfs5dN>discord</a> </p>
        ...
        <li>Telling nobodycares that hes a dumbass. but dont forget to give him head pats :3</li>
        ...
        <li>Troubleshooting the error on the <a href="https://github.com/The-Ghost-Network/Ghost" target="_blank">GitHub repository</a></li>
        </ul>
        <button id="reload">Reload</button>
        <hr />
        <p><i>Ultraviolet || Ghost<span id="uvVersion"></span></i></p>
        <script src="${
